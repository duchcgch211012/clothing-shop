...
export default function ProductDetail() {
  ...
  const addToCart = () => {
    ...
    const updated = existing
      ...
      : [...cart, { ...product, qty, selectedSize, selectedColor, cartKey: key }]
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.imageSection}>
            <div style={styles.mainImgWrap}>
              ...
              {product.stock === 0 && <div style={styles.soldOutBadge}>Hết hàng</div>}
            </div>
...
const styles = {
  ...
  soldOutBadge: { position: "absolute", top: "16px", left: "16px", background: "rgba(0,0,0,0.7)", color: "#fff", padding: "6px 14px", borderRadius: "8px", fontSize: "13px", fontWeight: "500" },
  ...
  price: { fontSize: "28px", fontWeight: "700", color: "#111", margin: "0 0 16px" },
